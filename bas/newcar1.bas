...
LOCATE 4, 64: PRINT "UNITA' NEMICA Nø1"
LOCATE 6, 64: PRINT "  CARRO  ARMATO  "
LOCATE 8, 64: PRINT "                 "
LOCATE 10, 64: PRINT "                 "

asa = (abx - dx) + (aby - dy): IF asa < 0 THEN asa = asa * (-1)
asb = (abx - ax) + (aby - ay): IF asb < 0 THEN asb = asb * (-1)
asd = (abx - fx) + (aby - fy): IF asd < 0 THEN asd = asd * (-1)
ase = (abx - gx) + (aby - gy): IF ase < 0 THEN ase = ase * (-1)
asf = (abx - hx) + (aby - hy): IF asf < 0 THEN asf = asf * (-1)
asg = (abx - ix) + (aby - iy): IF asg < 0 THEN asg = asg * (-1)

31010 IF pu = 0 THEN GOTO 31015
peppa = 1
IF asa < asb THEN GOTO 31011
31011 IF asa < asd THEN GOTO 31012
...
31016 IF asb < asd THEN GOTO 31017
...
peppa = 3
IF asd < asa THEN GOTO 31021
31021 IF asd < asb THEN GOTO 31022
31022 IF asd < ase THEN GOTO 31023
31023 IF asd < asf THEN GOTO 31024
31024 IF asd < asg THEN GOTO 31100

31025 IF qu = 0 THEN GOTO 31030
peppa = 4
IF ase < asa THEN GOTO 31026
31026 IF ase < asb THEN GOTO 31027
31027 IF ase < asd THEN GOTO 31028
...
31032 IF asf < asd THEN GOTO 31033
...
31037 IF asg < asd THEN GOTO 31038
...
31100 
RANDOMIZE TIMER
IF peppa = 1 THEN opla = INT(asa * RND)
IF peppa = 2 THEN opla = INT(asb * RND) - 10
IF peppa = 3 THEN opla = INT(asd * RND) - 20
IF peppa = 4 THEN opla = INT(ase * RND) - 30
IF peppa = 5 THEN opla = INT(asf * RND) - 40
IF peppa = 6 THEN opla = INT(asg * RND) - 50
...
30110 IF rz > (gfr - 15) AND rz < (gfr + 15) AND qw > (frg - 15) AND qw < (frg + 15) THEN opla = opla + 40
IF rz > (add - 15) AND rz < (add + 15) AND qw > (dda - 15) AND qw < (dda + 15) THEN opla = opla + 40
IF rz > (qqw - 10) AND rz < (qqw + 10) AND qw > (wqq - 10) AND qw < (wqq + 10) THEN opla = opla + 30
IF rz > (zzx - 25) AND rz < (zzx + 25) AND qw > (xzz - 25) AND qw < (xzz + 25) THEN opla = opla + 60
IF rz > (cas - 40) AND rz < (cas + 40) AND qw > (sac - 40) AND qw < (sac + 40) THEN opla = opla + 90
IF rz > (roc - 10) AND rz < (roc + 10) AND qw > (cor - 10) AND qw < (cor + 10) THEN opla = opla + 30
IF rz > (rew - 10) AND rz < (rew + 10) AND qw > (wer - 10) AND qw < (wer + 10) THEN opla = opla + 30
IF rz > (tre - 10) AND rz < (tre + 10) AND qw > (ert - 10) AND qw < (ert + 10) THEN opla = opla + 30
IF rz > (asd - 40) AND rz < (asd + 40) AND qw > (dsa - 40) AND qw < (dsa + 40) THEN opla = opla + 70

IF opla > 0 AND opla < 30 THEN yua = 0
IF opla > 30 AND opla < 60 THEN yua = 1
IF opla > 60 AND opla < 90 THEN yua = 2
IF opla > 90 AND opla < 120 THEN yua = 3
IF opla > 120 AND opla < 150 THEN yua = 4
IF opla > 150 AND opla < 180 THEN yua = 5
IF opla > 180 AND opla < 210 THEN yua = 6
IF opla > 210 AND opla < 240 THEN yua = 7
IF opla > 240 AND opla < 270 THEN yua = 8
IF opla > 270 THEN yua = 9
