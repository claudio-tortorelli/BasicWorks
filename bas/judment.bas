...
RANDOMIZE TIMER
cico = INT(9 * RND)
IF cico = 0 THEN PALETTE 10, 8: COLOR 10: GOTO 111
IF cico = 1 THEN PALETTE 2, 7: COLOR 2: GOTO 111
IF cico = 2 THEN PALETTE 3, 8: COLOR 3: GOTO 111
IF cico = 3 THEN PALETTE 4, 7: COLOR 4: GOTO 111
IF cico = 4 THEN PALETTE 5, 7: COLOR 5: GOTO 111
IF cico = 5 THEN PALETTE 6, 17: COLOR 6: GOTO 111
IF cico = 6 THEN PALETTE 12, 38: COLOR 12: GOTO 111
IF cico = 7 THEN PALETTE 13, 7: COLOR 13: GOTO 111
IF cico = 8 THEN PALETTE 9, 7: COLOR 9: GOTO 111
111 ass = ass + 1
CIRCLE (320, dc), ass, , , , 7 / 20
NEXT v
