...
'parit… totale
IF a = b AND a = c AND b = c AND a = d THEN PRINT "a b c d pareggiano": bim = 11: urk = 11: meo = 11: bee = 19: INPUT "Vuoi continuare la giostra?"; ssd$: IF ss$ = "s" THEN GOTO 3885: IF ssd$ <> "s" THEN GOTO 7737
