...
747 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": ss = 2: SLEEP
748 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": sl = 2: SLEEP
749 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": pc = 2: SLEEP
750 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": sa = 2: SLEEP
LOCATE 1, 2: PRINT "..PUNTI                        ": SLEEP
...
77 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": ss = 1: SLEEP
78 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": sl = 1: SLEEP
79 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": pc = 1: SLEEP
81 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": sa = 1: SLEEP
LOCATE 1, 2: PRINT "..PUNTI                        ": SLEEP
...
43 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": ss = 3: SLEEP
44 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": sl = 3: SLEEP
45 a$ = INPUT$(1): LOCATE 1, 2: PRINT "HA MARCATO                     ": pc = 3: SLEEP
46 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": sa = 3: SLEEP
LOCATE 1, 2: PRINT "PUNTI                          ": SLEEP
386 COLOR 8
...
838 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": ss = 4: SLEEP
839 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": SLEEP
840 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": SLEEP
841 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": SLEEP
LOCATE 1, 2: PRINT "..PUNTI.                       ": SLEEP
...
714 LOCATE 1, 2: PRINT "IL QUARTIERE DI PORTA DEL FORO": GOTO 875
715 LOCATE 1, 2: PRINT "IL QUARTIERE DI PORTA CRUCIFERA": GOTO 875
716 LOCATE 1, 2: PRINT "IL QUARTIERE DI PORTA S.ANDREA": GOTO 875
875 a$ = INPUT$(1): LOCATE 1, 2: PRINT "...HA MARCATO                  ": SLEEP
LOCATE 1, 2: PRINT "..PUNTI..                      ": SLEEP
