...
PRINT "variopinto corteo storico, i cavalieri dei quartieri di Porta Crucifera,"
...
COLOR 4, 7
PSET (150, 50)
REM DRAW "r300d200l300u200 r123d85l123d30r123d85r55u85r122u30l123u85"
CIRCLE (300, 150), 30
...
762 COLOR 8
LINE (80, 260)-(100, 310), , BF: LINE (120, 260)-(140, 310), , BF: a$ = INPUT$(2): FOR x = 1 TO 10000: NEXT x: GOTO 66
...
a$ = INPUT$(2): FOR x = 1 TO 10000: NEXT x: GOTO 66
...
LOCATE 6, 8: PRINT " -     S.SPIRITO: "; DSS
LOCATE 8, 8: PRINT " -     S.LORENTINO: "; DSL
LOCATE 10, 8: PRINT " -     PORTA CRUCIFERA: "; DPC
LOCATE 12, 8: PRINT " -     S.ANDREA: "; DSA
...
d = DSA
'maggioranza totale
IF a > b AND a > c AND a > d THEN PRINT "ha vinto ", a ELSE GOTO 7737
IF b > a AND b > c AND b > d THEN PRINT "ha vinto ", b ELSE GOTO 7737
IF c > a AND c > b AND c > d THEN PRINT "ha vinto ", c ELSE GOTO 7737
IF d > a AND d > b AND d > c THEN PRINT "ha vinto ", d ELSE GOTO 7737

'pareggio in a
IF a > b AND a = c AND a > d THEN PRINT a; "e", c; "pareggiano" ELSE GOTO 3885
IF a > c AND a = b AND a > d THEN PRINT a; "e", b; "pareggiano" ELSE GOTO 3885
IF a > c AND a > b AND a = d THEN PRINT a; "e"; d; "pareggiano" ELSE GOTO 3885

'pareggio in b
IF b > a AND b = c AND b > d THEN PRINT b; "e"; c; "pareggiano" ELSE GOTO 3885
IF b > a AND b > c AND b = d THEN PRINT b; "e"; d; "pareggiano" ELSE GOTO 3885
IF c > a AND c > b AND c = d THEN PRINT c; "e"; d; "pareggiano" ELSE GOTO 3885

'pareggio a tre
IF a > b AND a = c AND a = d THEN PRINT a; c; d; "pareggiano" ELSE GOTO 3885
IF a = b AND a > c AND a = d THEN PRINT a; b; d; "pareggiano" ELSE GOTO 3885
IF a = b AND a = c AND a > d THEN PRINT a; b; c; "pareggiano" ELSE GOTO 3885
IF b > a AND b = c AND b = d THEN PRINT b; c; d; "pareggiano" ELSE GOTO 3885


'parit… totale
IF a = b AND a = c AND b = c AND a = d THEN PRINT a; b; c; d; "pareggiano": INPUT "Vuoi continuare la giostra?"; ssd$: IF ss$ = "s" THEN GOTO 3885: IF ssd$ <> "s" THEN GOTO 7737
