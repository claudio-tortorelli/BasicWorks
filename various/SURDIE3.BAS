'ricorda:
'riguardare la sez. battaglia, quando ci sono le
'distanze tra due soldati, anche l'effetto cratere
'successivo ad un'esplosione
'attivare controllo in caso di perdita del computer
'attivare il nemico n.1 quando gli altri sono andati
'fare sezione della bomba atomica, e della fucilaz
'sezione della vittoriA
...
IF car1 = 0 AND car2 = 0 AND sol1 = 0 AND sol2 = 0 AND sol3 = 0 AND sol4 = 0 THEN END
...
LOCATE 2, 64: PRINT "     ATTACCA     "
LOCATE 4, 64: PRINT "UNITA' NEMICA Nø2"
LOCATE 6, 64: PRINT "  CARRO  ARMATO  "
...
LOCATE 2, 64: PRINT "     ATTACCA     "
LOCATE 4, 64: PRINT "UNITA' NEMICA Nø3"
...
LOCATE 2, 64: PRINT "     ATTACCA     "
LOCATE 4, 64: PRINT "UNITA' NEMICA Nø4"
LOCATE 6, 64: PRINT "     SOLDATO     "
...
LOCATE 2, 64: PRINT "     ATTACCA     "
LOCATE 4, 64: PRINT "UNITA' NEMICA Nø5"
LOCATE 6, 64: PRINT "     SOLDATO     "
...
LOCATE 2, 64: PRINT "     ATTACCA     "
LOCATE 4, 64: PRINT "UNITA' NEMICA Nø6"
LOCATE 6, 64: PRINT "     SOLDATO     "
