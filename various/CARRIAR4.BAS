...
REM Il computer continua a sparare anche agli obbiettivi distrutti.
REM Non riconosce quando tutte le pedine mancano e deve finire.
...
IF vala < valb AND vala < valc AND vala < vald AND vala < vale AND vala < valf THEN 50005
IF valb < valc AND valb < vald AND valb < vale AND valb < valf AND valb < vala THEN 50006
IF valc < vald AND valc < vale AND valc < valf AND valc < vala AND valc < valb THEN 50007
IF vald < vale AND vald < valf AND vald < vala AND vald < valb AND vald < valc THEN 50008
IF vale < valf AND vale < vala AND vale < valb AND vale < valc AND vale < vald THEN 50009
IF valf < vala AND valf < valb AND valf < valc AND valf < vald AND valf < vale THEN 50010
