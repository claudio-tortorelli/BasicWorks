...
CLS
COLOR 14, 3
LOCATE 8, 20: PRINT "1) EQUAZIONI PURE"
LOCATE 11, 20: PRINT "2) EQUAZIONI SPURIE"
LOCATE 14, 20: PRINT "3) EQUAZIONI COMPLETE"
LOCATE 17, 20: PRINT "4) FINE"

5540 LOCATE 20, 20: PRINT "IMMETTI IL TIPO DELL'EQUAZIONE DA RISOLVERE": B$ = INPUT$(1)
IF B$ = "1" THEN GOTO 200
IF B$ = "2" THEN GOTO 200
IF B$ <> "4" THEN GOTO 5540
IF B$ = "3" THEN GOTO 200
IF B$ = "4" THEN END
...
CLS
COLOR 4, 14
LOCATE 5, 20: PRINT "--------- PURE (AX2 + C) ---------"
LOCATE 14, 5
INPUT "    IMMETTI IL VALORE DI X AL QUADRATO    "; A
LOCATE 14, 5
INPUT "    IMMETTI IL VALORE DI C                "; C
R = INT(-C / A)
LOCATE 17, 15: PRINT "RISULTATO: RADICE QUADRATA DI +/- ", R
A$ = INPUT$(1): CLS
GOTO 1
